    ...
    <div class="wrap-content">
        ...
        <aside class="menu-aside">
            ...
            <nav class="menu-aside-navi">
                <ul class="menu-aside-main" id="legalNavi">
                    <li id="menu_service"><a href="/legal/service">Terms of Service<i
                                    class="arrow-menu"></i></a>
                        <!-- ul class="menu-aside-sub">
                            <li id="sub_menu_service"><i class="aside-sub-menu"></i><a href="/legal/service/service">통합서비스</a></li>
                            <li id="sub_menu_security"><i class="aside-sub-menu"></i><a href="/legal/security/security">보안서비스</a></li>
                        </ul -->
                    </li>
                    <li id="menu_privacy"><a href="/legal/privacy">Privacy Policy<i
                                    class="arrow-menu"></i></a></li>
                    <li id="menu_bslt"><a href="/legal/bslt">BSLT Deposit and
                            Withdrawal Policy<i class="arrow-menu"></i></a></li>
                    <li id="menu_security"><a href="/legal/security">Security
                            Service Policy<i class="arrow-menu"></i></a></li>
                </ul>
            </nav>
        </aside>
        <?php $this->beginBody() ?>
...
<footer class="footer">
    ...
    <ul class="menu-footer">
        <li><a href="https://company.xlgames.com/en" target="_blank">关于我们</a><i
                    class="global-gnb-footer-line">|</i></li>
        <li><a href="https://member.archeworld.com/legal/service/service">服务协议</a><i
                    class="global-gnb-footer-line">|</i></li>
        <li><a href="https://member.archeworld.com/legal/privacy/privacy"><strong>隐私政策</strong></a></li>
    </ul>
...
<script type="text/javascript" src="/resources-202412261502/js/legal.navigation.js"></script>
