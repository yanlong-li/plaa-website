...
(function ($m$$) {
    AL10N.Global = {
        accessDenied: $m$$("No authority."),
        accessDeniedCancelingUser: $m$$("Membership withdrawal is in progress."),
        accessDeniedChannelCancelingUser: $m$$("Game service cancellation is in progress."),
        accessDeniedNotCertifiedUser: $m$$("Wallet verification has not been completed.\nPlease complete the Wallet verification on the [Edit account info]."),
        accessDeniedPreserveUser: $m$$("We've detected suspicious activity on your account and have temporarily locked it."),
        ...
        accessDeniedStealUser: $m$$("This account is reported as a compromised account."),
        cautionProcessStep: $m$$("Any unsaved information will be deleted if you leave this page."),
        ...
        gameInMaintenance: $m$$("Game service is under maintenance.\nPlease check the announcement."),
        gameMgmt: $m$$("We are under maintenance."),
        gameRestrictions: $m$$("You account has been limited. \nPlease contact Customer Support."),
        gameTokenFail: $m$$("Sorry we are unable to process your request. \nPlease try again later."),
        imageMaxFileSize: $m$$("You can register image file up to 3MB."),
        loginRequired: $m$$("Please login."),
        overUploadMaxFileCount: $m$$("You can add up to {0} page at a time."),
        overUploadMaxFileSize: $m$$("File exceeded the maximum upload size."),
        prepareOpen: $m$$("Preparing"),
        ...
        loginFailTrayAgain: $m$$("Log in failed. Please try again."),
        defaultErrorMessage: "System error. Please contact administrator!"
    };
    AL10N.Browser = {
    ...
    AL10N.Button = {
        cancel: $m$$("Cancel"), deleteFile: $m$$("Delete"), findFile: $m$$("Browse"), ok: $m$$("Ok"),
        registering: $m$$("ing..."), save: $m$$("Save"), close: $m$$("Close")
    };
    AL10N.MultiBoard = {
    ...
    AL10N.Comment =
        {
            confirmDel: $m$$("Do you want to delete comment?"),
            contentsLength: $m$$("Please type the content in {0} or more and {1} or fewer letters."),
            deleteFailure: $m$$("Failed to delete comment."),
            deleteNotOwner: $m$$("Not an author.")
        };
    AL10N.Search = {
        keywordEmpty: $m$$("Please enter keywords."),
    ...
    AL10N.Vote = {
        requiredOwnerArticle: $m$$("본인글은 투표할 수 없습니다."),
        alredyVoted: $m$$("이미 투표하셨습니다.")
    };
    AL10N.NickName = {
    ...
    AL10N.Weblauncher = {
        install: $m$$("Please install the launcher."),
        reqInstall: $m$$("Please install the launcher first to run the game."),
        downloadAndInstall: $m$$("Please click the Manually Download button to install the launcher."),
        btnDownload: $m$$("Manually Download"),
        requestCs: $m$$("If you encounter any problems while installing or launching the game, please contact us."),
        btnCs: $m$$("Customer Support"),
        alreadyInstallMsg: $m$$("I've already installed the launcher. Do not show this again."),
        closeMsg: $m$$("Don't show this again."),
        notSupportOs: $m$$("The operating system is not supported.")
    };
    AL10N.Wallet = {
    ...
    AL10N.Member = {
        ...
        requiredUsername: $m$$("Enter a valid email address."),
        requiredSsn: $m$$("주민등록번호를 입력해 주세요."),
        requiredSsnAgree: $m$$("주민등록번호 수집 및 이용에 동의해 주세요."),
        requiredCancelAnswer: $m$$("Enter a cancellation reason to complete membership withdrawal."),
        maxlengthCancelAnswer: $m$$("You can't type more than 200 letters."),
        requiredAnswer: $m$$("답변을 입력해 주세요."),
        requiredPassword: $m$$("Enter password."),
        requiredCurrentPassword: $m$$("Enter your current password."),
        requiredNewPassword: $m$$("Enter your new password."),
        requiredNewPasswordConfirm: $m$$("Please re-enter your password."),
        requiredEmail: $m$$("Enter your email address."),
        confirmUserAgree: $m$$("Please agree to the Terms of Service."),
        confirmPersonalAgree: $m$$("Please read and agree to the Privacy Policy."),
        confirmPersonalTrustAgree: $m$$("Please confirm that you agree to our Terms of Service and Privacy Policy."),
        conrirmUserAgreeAndPersonalAgree: $m$$("Proceed Wallet Verification or Mobile Wallet Verification to get a full access to all the services."),
        requiredBirthDate: $m$$("생년월일을 입력해 주세요."),
        invalidBirthDate: $m$$("정확한 법정 생년월일을 입력해 주세요."),
        requiredConfirmPassword: $m$$("Please re-enter your password."),
        confirmPassword: $m$$("Passwords do not match."),
        confirmOldPassword: $m$$("The current password and the new password are the same.\x3cbr\x3ePlease enter a different password."),
        requiredCaptcha: $m$$("Check the checkbox."),
        invalidCaptchaFormat: $m$$("Check the checkbox."),
        invalidEmail: $m$$("Enter a valid email address."),
        ...
        invalidPhoneAuthNumber: $m$$("Enter valid verification code."),
        maxLengthPhoneAuthNumber: $m$$("Enter valid verification code."),
        phoneAuthNumberMismatch: $m$$("verification code doesn't match."),
        minlengthPassword: $m$$("Password must be 8-16 characters containing both numbers and letters/special characters."),
        maxlengthPassword: $m$$("Password must be 8-16 characters containing both numbers and letters/special characters."),
        ...
        invalidPasswordFormat: $m$$("Password \x3cem\x3emust be 8-16 characters containing both numbers and letters/special characters.\x3c/em\x3e"),
        invalidEmailFormat: $m$$("Enter a valid email address."),
        invalidEmailFormatAuth: $m$$("This email address is already in use."),
        sentAuthMail: $m$$("To complete verification and sign up, please click the link in the verification email within 24 hours."),
        ...
        requiredCancelConfirm: $m$$("Please confirm and agree to the above."),
        requiredAccountIds: $m$$("아이디를 선택해 주세요."),
        resendAuthEmail: $m$$("A verification email has been resent."),
        joinResendAuthEmailFail: $m$$("Failed to resend a verification email. \nPlease check if the email address is valid."),
        transIdResendAuthEmailFail: $m$$("Failed to resend a verification email. \nPlease check if the email address is valid."),
        passwordByEmail: $m$$("A verification email has been sent.\nIf certification is not completed within 24 hours,\nthe certification is automatically revoked."),
        invalidPasswordByEmail: $m$$("Enter a valid email address."),
        needPhoneAuthCheck: $m$$("휴대폰 소유인증을 해주세요."),
        requiredLogout: $m$$("Please logout first before attempting to proceed.")
    };
    AL10N.EmailAuth = {
        invalidAuthCode: $m$$("Enter valid verification code."),
        mismatchAndExpireAuthCode: $m$$("The verification code is valid for 10 minutes."),
        resendFail: $m$$("Failed to send a verification email. \nPlease try again later."),
        resendComplete: $m$$("A verification email has been sent to the requested email address.")
    };
    AL10N.Btn = {
        cancel: $m$$("Cancel"),
        deleteFile: $m$$("Delete"),
        ...
        registering: $m$$("ing..."),
        save: $m$$("Save"),
        emailVerification: $m$$("Email verification"),
        inprogress: $m$$("ing..."),
        authenticating: $m$$("authenticating")
    };
    AL10N.Bora = {
        ready: $m$$("Connecting to BORA PORTAL"),
        connected_user: $m$$("Connecting by a user already verified on BORA PORTAL"),
        connected_wallet: $m$$("Connecting with the wallet already connected to BORA PORTAL."),
        expired: $m$$("Connection time out"),
        exception: $m$$("An error has occurred. Please try again.")
    }
