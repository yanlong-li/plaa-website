...
*
<script type="module">
	import {createApp} from "{{urlJs "/www.xbluesalt.io/js/share/lib/vue.js/3.2.47/vue.js"}}";
	import {cookieApp} from "{{urlJs "/www.xbluesalt.io/js/cookie/cookiemanage_service.min.js"}}";
 ...
 const cookieApp = {
     ...
     methods: {
         ...
         cookieAccept: function(){
             ...
             document.cookie = COOKIE_NAME + "=true;path=/;Expires=" + new Date(expires);
