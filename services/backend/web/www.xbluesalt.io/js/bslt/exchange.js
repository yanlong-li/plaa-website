import { Face, Network } from '/www.xbluesalt.io/lib/facewallet/facewallet1.9.2.js';
import { ethers } from "/www.xbluesalt.io/lib/ethereum/ethers-5.0.esm.min.js";
...
$(async function () {
    ...
    let networkInfo = await axios.get("/www.xbluesalt.io/api/bslt/facewallet/network.json");
