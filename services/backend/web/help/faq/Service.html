...
<head>
	...
	<meta property="og:url" content="https://www.archeworld.com/help/faq/Service"/>
	<meta property="og:image" content="https://www.archeworld.com/resources-202501091402/images/sns.jpg" />
	...
	<meta name="_csrf" content="71722f34-f391-419a-ab20-25a06b120d80" />
	...
	<link href="/resources-202501091402/css/common_t.css" media="screen and (min-width:768px) and (max-width:1199px)" rel="stylesheet" />
	...
	<header role="banner" id="portal-gnb" class="portal-gnb">
		...
		<div class="account-util">
			<ul>
					...
					<li>
						<a href="/user/login/form.html?forwardUrl=https://www.archeworld.com/help/faq/Service" class="btn-portal-login">
	...
	<div class="masthead">
		...
		<div class="global-navi-side" id="global-navi">
			...
			<nav role="navigation" id="common-navi" class="masthead-navi">
				...
				<h2>menu</h2>
				<ul class="navi">
					<li class="m1" id="menu_news"><a href="/news.html">News</a></li>
					<li class="m2" id="menu_guide"><a href="/guide.html">Guide</a></li>
					...
					<li class="m6" id="menu_help"><a href="/help/faq.html" class="navi-link">Customer Support</a>
						<div class="sub-navi">
							<ul>
								<li id="menu_sub_faq"><a href="/help/faq.html">FAQ</a></li>
			...
			<a href="/user/login/form.html?forwardUrl=https://www.archeworld.com/help/faq/Service" class="nav-login">Log In</a>
			...
			<ul class="lst_faq">
				...
				<li class="subject ">
					<em>Q</em>
						...
						&#39;different networkId&#39; error occurs when I try to verify my wallet after ArcheWorld sign up process.
					</a>
				</li>
...
<div class="paging">
	<div class="pg-inner">
		 <a href="/help/faq/Service/?page=1" class="active"  onclick="return false;">1</a>  <a href="/help/faq/Service/?page=2">2</a>  <span class="pg-more"> ... </span>  <a href="/help/faq/Service/?page=2" class="pg-navi" accesskey="x" title="2 page">NEXT <i class=ico-page-next></i></a> 
	</div>
</div>
	...
	<script type="text/javascript" src="/resources-202501091402/js/share/lib/jquery.cookie/1.4.1/jquery.cookie.js"></script>
	<script type="text/javascript" src="/resources-202501091402/js/share/lib/swiper/8.0.6/swiper-bundle.min.js"></script>	
...
(function($) {
	...
	XLGames.currentFullUrl = 'https://www.archeworld.com/help/faq/Service';
